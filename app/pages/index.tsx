...
const Home: NextPage = () => {
  return (
    <div>
      <Head>
        <title>Next JS Web3 Starter Pack</title>
        <meta
          name="description"
          content="A modern, full-stack Next.js & Web3 boilerplate with Docker, TypeScript, Hardhat, NextAuth.js, Tailwind, Postgres, and painless local development for your next Web3 project."
        />
        <meta property="og:title" content="Next JS Web3 Starter Pack" />
        <meta property="og:url" content="https://www.evmjs.com/" />
        <meta
